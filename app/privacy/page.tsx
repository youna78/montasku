  ...
  return (
    <LegalPageLayout title="プライバシーポリシー">
        <div className="legal-intro">
          モンタスク（以下「本サービス」）は、ユーザー認証、ゲームデータの保存、機種変更時の引き継ぎその他本サービスの提供のため、
          必要な範囲で個人情報を取得・利用します。
        </div>
        ...
        <div className="legal-section">
          <h2>4. データの管理</h2>
          <p>
            本サービスは、取得した情報を適切に管理し、不正アクセス、紛失、漏えい等の防止に努めます。
          </p>
        </div>

        <div className="legal-section">
          <h2>5. お問い合わせ</h2>
          <p>本サービスに関するお問い合わせは、今後設定するお問い合わせ窓口より受け付けます。</p>
        </div>

        <div className="legal-section">
          <h2>6. 改定</h2>
          <p>本ポリシーは、必要に応じて改定する場合があります。</p>
        </div>
    </LegalPageLayout>
  );
}
